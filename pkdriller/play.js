...
zokou({
  ...
  try {
    ...
    const apis = [
      ...
      `https://api.giftedtech.web.id/api/download/yta?url=${encodeURIComponent(videoUrl)}`,
      `https://api.giftedtech.web.id/api/download/dlmp4?url=${encodeURIComponent(videoUrl)}&apikey=gifted-md`,
      `https://api.giftedtech.web.id/api/download/ytaudio?url=${encodeURIComponent(videoUrl)}`
    ];
